...
public class UpYun {
     ...
     * 
     * @param key
     *        信息字段名（x-upyun-width、x-upyun-height、x-upyun-frames、x-upyun-
     *        file -type）
     * 
    ...
    public enum PARAMS {
         ...
         * 缩略图参数值
         * <p>
         * 说明：该参数必须搭配 KEY_X_GMKERL_TYPE 使用，否则无效。具体的值需要根据 KEY_X_GMKERL_TYPE
         * 而定。
         */
         ...
         * <p>
         * 说明：参数格式为x,y,width,height，且需要满足 x >= 0 && y >=0 && width > 0 &&
         * height > 0
         * 
